<template>
  <div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 mb-8 flex items-center justify-between">
      <div>
        <h2 class="text-2xl font-bold text-gray-900">Kit de Communication</h2>
        <p class="text-gray-600">Gérez la valeur selon les paliers de licences</p>
      </div>
      <button 
        @click="saveChanges"
        class="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold px-8 py-3 rounded-xl transition-all shadow-lg hover:shadow-xl flex items-center gap-2"
      >
    ...
    <!-- Configuration par Paliers de Licences -->
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl shadow-lg p-8 mb-8 border-2 border-blue-200">
      <h3 class="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
        <svg class="w-6 h-6 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
          <path fill-rule="evenodd" d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11.707 4.707a1 1 0 00-1.414-1.414L10 9.586 8.707 8.293a1 1 0 00-1.414 0l-2 2a1 1 0 101.414 1.414L8 10.414l1.293 1.293a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
        </svg>
        Valeur par Palier de Licences
      </h3>
      ...
      <div class="grid md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl p-6 border-2 border-blue-300">
          <div class="flex items-center justify-between mb-4">
            <div>
              <h4 class="font-bold text-gray-900">1-49 licences</h4>
              <p class="text-sm text-gray-600">Kit Standard</p>
            </div>
          ...
          <div>
            <label class="block text-sm font-bold text-gray-700 mb-2">Valeur offerte (€)</label>
            <input 
              v-model.number="formData.valeur1_49"
              type="number"
              min="0"
              step="1"
              class="w-full px-4 py-3 border-2 border-blue-200 rounded-xl focus:border-blue-500 focus:outline-none text-2xl font-bold text-blue-600"
            >
          </div>
        </div>

        <!-- 50+ licences -->
        <div class="bg-white rounded-xl p-6 border-2 border-indigo-300">
          <div class="flex items-center justify-between mb-4">
            <div>
              <h4 class="font-bold text-gray-900">50+ licences</h4>
              <p class="text-sm text-gray-600">Kit Premium</p>
            </div>
          ...
          <div>
            ...
            <input 
              ...
              min="0"
              step="1"
              class="w-full px-4 py-3 border-2 border-indigo-200 rounded-xl focus:border-indigo-500 focus:outline-none text-2xl font-bold text-indigo-600"
            >
          </div>
        </div>
      </div>
    ...
    <div class="grid md:grid-cols-2 gap-8">
      ...
      <div class="bg-white rounded-2xl shadow-lg p-8 space-y-6">
        ...
        <!-- Valeur -->
        <div>
          <label class="block text-sm font-bold text-gray-700 mb-2">Valeur offerte (€ par licence)</label>
          <input 
            v-model.number="formData.valeur"
            type="number"
            min="0"
            step="1"
            class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:outline-none text-2xl font-bold text-blue-600"
          >
        </div>
        ...
        <div>
          ...
          <textarea 
            ...
            rows="3"
            class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:outline-none resize-none"
          ></textarea>
        </div>
      </div>
        ...
        <div>
          ...
          <div class="flex gap-2">
            <input 
              v-model="newImageUrl"
              type="text"
              placeholder="/kit-communication-2.jpg"
              class="flex-1 px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:outline-none"
            >
            <button 
              @click="addImage"
              class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold transition-colors flex items-center gap-2"
            >
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 mt-8">
      ...
      <div class="grid md:grid-cols-2 gap-6">
        <div 
          ...
          :class="detail.visible ? 'bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-300' : 'bg-gray-50 border-gray-200 opacity-60'"
        >
          ...
          <div class="space-y-3">
            <div>
              ...
              <input 
                ...
                type="text"
                placeholder="Ex: PLV Sur Mesure"
                class="w-full px-4 py-3 bg-white border-2 border-blue-200 rounded-xl font-semibold text-gray-900 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all"
              >
            </div>
            ...
            <div>
              ...
              <textarea 
                ...
                rows="3"
                placeholder="Ex: Totems, kakémonos, stop-rayons..."
                class="w-full px-4 py-3 bg-white border-2 border-blue-200 rounded-xl text-sm text-gray-700 resize-none focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all"
              ></textarea>
            </div>
          </div>
...
onMounted(() => {
  ...
  formData.value = JSON.parse(JSON.stringify(adminStore.kitCommunication))
})
...
const saveChanges = () => {
  adminStore.updateKitCommunication(formData.value)
